import { Box, Heading, Text, SimpleGrid, Center, Wrap, WrapItem } from "@chakra-ui/react";
...
export default function Reviews(props: ReviewsDataFragment) {
  return (
    <Box px="50px" align="center">
      <Heading as="h2" size="xl" pb={8}>{props.heading}</Heading>
