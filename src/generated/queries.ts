...
export type NavbarDataFragment = (
  { __typename?: 'Navbar' }
  & { logo: (
    { __typename?: 'Asset' }
    & Pick<Asset, 'url'>
    ...
    & { items: Array<(
      { __typename?: 'NavbarButton' }
      & Pick<NavbarButton, 'isBrandColorBackground'>
      & { texturlPair: (
        { __typename?: 'FooterLink' }
        & TextUrlPairDataFragment
      ) }
...
export type TwoBlocksDataFragment = (
  { __typename?: 'TwoBlocks' }
  & Pick<TwoBlocks, 'leftTitle' | 'rightTitle'>
  & { leftImage: (
    { __typename?: 'Asset' }
    & Pick<Asset, 'url'>
  ), leftButton: (
...
export const NavbarDataFragmentDoc = gql`
  ...
  buttonsCollection {
    ...
    ${TextUrlPairDataFragmentDoc}`;
export const TwoBlocksDataFragmentDoc = gql`
